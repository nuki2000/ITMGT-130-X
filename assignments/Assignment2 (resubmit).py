...
print(relationship_status("@eeebeee", "@bongolpoc", social_graph))
...
def eta(first_stop, second_stop, route_map):
    ...
    while loop[1] != second_stop:
        final+= route_map[loop]['travel_time_mins']
        for i in route_map.keys():
            if i[1] == second_stop:
                loop = i
    final += route_map[loop]['travel_time_mins']
...
print(eta("admu", "upd", route_map))
print(eta("dlsu", "upd", route_map))
print(eta("upd", "admu", route_map))
print(eta("admu", "dlsu", route_map))
